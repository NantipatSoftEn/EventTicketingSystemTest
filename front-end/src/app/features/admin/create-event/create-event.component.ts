...
export class CreateEventComponent {
    ...
    autoFillForm(): void {
        ...
        this.eventForm = {
            ...
            description:
                'Join us for an amazing summer music festival featuring top artists from around the world. Experience live performances, food trucks, and amazing atmosphere under the stars.',
