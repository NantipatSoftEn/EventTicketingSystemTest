...
export class ApiService {
    ...
    getEvents(filters?: EventFilters): Observable<Event[]> {
        ...
        return this.handleResponse(
            this.http.get<ApiResponse<any[]>>(`${this.baseUrl}/events`, {
                params,
            })
        ).pipe(
    ...
    getEventById(id: string): Observable<Event> {
        ...
        ).pipe(map(apiEvent => this.transformApiEventToFrontend(apiEvent)))
    }
    ...
    private transformFrontendEventToApi(
        event: Partial<Event> & { status?: string }
    ): any {
        const apiEvent: any = {}
    ...
    getBookingStats(eventId: string): Observable<any> {
        return this.handleResponse(
            this.http.get<ApiResponse<any>>(
                `${this.baseUrl}/bookings/event/${eventId}/stats`
            )
        )
    }
    ...
    getEventsForManagement(): Observable<EventManagement[]> {
        return this.handleResponse(
            this.http.get<ApiResponse<EventManagement[]>>(
                `${this.baseUrl}/events/management/view`
            )
        )
    }
    ...
    getEventAvailability(eventId: number): Observable<any> {
        return this.handleResponse(
            this.http.get<ApiResponse<any>>(
                `${this.baseUrl}/availability/${eventId}`
            )
        )
    }
    ...
    getMultipleEventsAvailability(eventIds: number[]): Observable<any> {
        ...
        return this.handleResponse(
            this.http.get<ApiResponse<any>>(`${this.baseUrl}/availability`, {
                params,
            })
        )
    }
    ...
    getAllActiveEventsAvailability(): Observable<any> {
        return this.handleResponse(
            this.http.get<ApiResponse<any>>(
                `${this.baseUrl}/availability/all/active`
            )
        )
    }
}
