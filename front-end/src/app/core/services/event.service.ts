...
export class EventService {
    ...
    private mockEvents: Event[] = [
        ...
        },
        {
            ...
            description:
                'Discover the latest trends in technology, AI, and innovation. Network with industry leaders and learn about cutting-edge developments shaping our future.',
        ...
        },
        {
            ...
            description:
                'Indulge in culinary delights from renowned chefs and sample premium wines from around the globe. A perfect weekend experience for food enthusiasts.',
        ...
        },
        {
            ...
            description:
                'Explore contemporary art from emerging and established artists. Interactive installations, guided tours, and exclusive artist meet-and-greets.',
        ...
        },
        {
            ...
            description:
                'Laugh until your sides hurt with our lineup of hilarious comedians. An evening of stand-up comedy, sketches, and interactive entertainment.',
        ...
        },
        {
            ...
            description:
                'Discover the latest in fitness equipment, wellness programs, and healthy living. Free workout sessions, nutrition consultations, and product demos.',
    ...
    updateEvent(
        id: string | number,
        event: Partial<Event> & { status?: string }
        ...
        if (this.devModeService.isDevMode) {
            ...
            return this.apiService
                .patchEvent(eventId.toString(), event)
    ...
    getVenues(): Observable<string[]> {
        if (this.devModeService.isDevMode) {
            const venues = [
                ...new Set(this.mockEvents.map(event => event.venue)),
            ]
            return of(venues)
        } else {
            ...
            if (this.isCacheLoaded) {
                const venues = [
                    ...new Set(this.cachedEvents.map(event => event.venue)),
                ]
                return of(venues)
            } else {
    ...
    reduceAvailableTickets(
        ...
        if (this.devModeService.isDevMode) {
            ...
            const cachedEvent = this.cachedEvents.find(
                e => e.id === numericEventId
            )
        ...
        if (this.devModeService.isDevMode) {
            ...
            if (!this.isManagementCacheLoaded) {
                return this.apiService.getEventsForManagement().pipe(
                    ...
                    catchError(error => {
                        console.error(
                            'Error fetching management events from API:',
                            error
                        )
                        return of([])
                    })
    ...
    private updateManagementEventInCache(
        id: string | number,
        updateData: Partial<Event> & { status?: string }
    ): void {
    ...
    private getMockEventsForManagement(): Observable<EventManagement[]> {
        const mockManagementData: EventManagement[] = [
            ...
            },
            {
                ...
                title: 'Tech Innovation Conference',
                description:
                    'Discover the latest trends in technology, AI, and innovation.',
                venue: 'Convention Center Downtown',
            ...
            },
            {
                ...
                title: 'Food & Wine Festival',
                description:
                    'Indulge in culinary delights from renowned chefs.',
                venue: 'Riverside Park',
